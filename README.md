...
[claudecode-skills](https://github.com/aprilde/claudecode-skills): a collection of Claude skills I've built and share — structured, reusable workflows that hand Claude a repeatable methodology for a specific kind of task. The first is a netnography skill that runs a guided study of an online community, from research question to an evidence-grounded findings report, following Kozinets's five-phase framework — with a human checkpoint at every phase so the researcher, not the AI, stays in control. The repo is built to grow as I add more.
